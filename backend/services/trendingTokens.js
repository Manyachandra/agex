...
//
// Pulls trending pools on Base from GeckoTerminal's free API and normalizes
// them into a list of WETH-paired tokens that agents can swap into/out of via
// Uniswap V3. No API key required.
...
const EXCLUDED_ADDRESSES = new Set([
  // USDC on Base. Stablecoins can trend, but they are not useful agent trade targets.
...
// Parse "base_0xabc..." token ids from GeckoTerminal relationships.
...
async function fetchTrendingTokens() {
  ...
  const url = `${GECKO_BASE}/networks/base/trending_pools?include=base_token,quote_token,dex&page=1`
...
module.exports = { fetchTrendingTokens, getSwappableTrending, WETH_BASE }
